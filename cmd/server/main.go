...
func main() {
	...
	adminRead.HandleFunc("/count-types", handlers.ListCountTypes).Methods("GET")
	adminRead.HandleFunc("/brands", handlers.GetBrands).Methods("GET")
	...
	admin.HandleFunc("/count-types", handlers.CreateCountType).Methods("POST")
	admin.HandleFunc("/count-types/{id}", handlers.UpdateCountType).Methods("PUT")
	admin.HandleFunc("/count-types/{id}", handlers.DeleteCountType).Methods("DELETE")
	admin.HandleFunc("/brands", handlers.CreateBrand).Methods("POST")
	admin.HandleFunc("/brands/{id}", handlers.UpdateBrand).Methods("PUT")
	admin.HandleFunc("/brands/{id}", handlers.DeleteBrand).Methods("DELETE")
	admin.HandleFunc("/manufacturers", handlers.CreateManufacturer).Methods("POST")
	admin.HandleFunc("/manufacturers/{id}", handlers.UpdateManufacturer).Methods("PUT")
	admin.HandleFunc("/manufacturers/{id}", handlers.DeleteManufacturer).Methods("DELETE")
	admin.HandleFunc("/products/bulk-delete", handlers.BulkDeleteProducts).Methods("POST")
	admin.HandleFunc("/products/bulk-update", handlers.BulkUpdateProducts).Methods("PUT")
	...
	admin.HandleFunc("/products/{id}/field-values", handlers.GetProductFieldValues).Methods("GET")
	admin.HandleFunc("/products/{id}/field-values", handlers.SetProductFieldValues).Methods("PUT")
	admin.HandleFunc("/product-field-definitions", handlers.GetProductFieldDefinitions).Methods("GET")
	admin.HandleFunc("/product-field-definitions", handlers.CreateProductFieldDefinition).Methods("POST")
	admin.HandleFunc("/product-field-definitions/{id}", handlers.UpdateProductFieldDefinition).Methods("PUT")
	admin.HandleFunc("/product-field-definitions/{id}", handlers.DeleteProductFieldDefinition).Methods("DELETE")
	...
	// Cable admin endpoints are removed - cables are now managed as products with custom field values
	admin.HandleFunc("/devices-list", handlers.GetAllDevicesAdmin).Methods("GET")
	admin.HandleFunc("/devices/bulk-delete", handlers.BulkDeleteDevices).Methods("POST")
	admin.HandleFunc("/devices/bulk-update", handlers.BulkUpdateDevices).Methods("PUT")
